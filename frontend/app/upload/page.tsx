...
export default function UploadPage() {
  ...
  const handleDrop = (
    ...
    if (isSupportedFile(droppedFile)) {
      ...
      setError(
        "Invalid format. Use PDF, DOCX, PNG, JPG, JPEG, or TXT."
      )
    }
  }
    ...
    <div className="min-h-screen flex flex-col p-4 md:p-8 animate-nothing">
      ...
      <header className="flex items-center justify-between mb-12 relative z-10">
        ...
        >
          ...
          <span className="n-dot font-bold tracking-tighter">
            medibotix
          </span>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/"
            className="btn-nothing h-10 px-4"
          >
      ...
      <main className="flex-1 max-w-2xl w-full mx-auto space-y-6">
        ...
        <div className="mb-12">
          ...
          <h2 className="n-serif text-5xl md:text-6xl mb-4 italic">
            UPLOAD.
          </h2>

          <p className="text-xs text-muted n-dot tracking-widest uppercase">
            Select Clinical Report for AI Processing
          </p>
        ...
        >
          ...
          <p className="n-dot font-bold text-sm mb-2">
            Drop Clinical Report
          </p>

          <p className="text-[10px] text-muted uppercase tracking-widest mb-12">
            PDF / DOCX / PNG / JPG / JPEG / TXT ONLY [10MB MAX]
          </p>
          ...
          {file && (
            ...
            <div className="nothing-widget p-4 bg-background border-primary border-[2px] flex items-center gap-4 w-full animate-nothing shadow-lg">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="font-mono text-[10px] font-bold truncate max-w-[200px] text-foreground">
                  {file.name}
                </p>

                <p className="text-[8px] text-muted opacity-100">
                  FILE READY FOR ENGINE
                </p>
        ...
        {error && (
          ...
          <div className="nothing-widget p-4 border-primary text-primary flex items-center gap-4">
            ...
            <p className="text-[10px] n-dot font-bold">
              {error}
            </p>
